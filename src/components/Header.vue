<template>
    <div class="h-16 bg-white flex">
        ...
        <div class="flex flex-col justify-center">
            <p class="text-lg leading-none uppercase text-[#00074e] font-bold mb-2">Desa Bantarjati</p>
        ...
        <div class="flex items-center h-full ml-auto pr-20">
            ...
            <a class="text-lg text-[#001b85] mx-4 cursor-pointer" href="berita">Berita</a>
